...
function Pagination({
  ...
  function onBulletClick(e) {
    const isBullet = e.target.matches(Object(_shared_classes_to_selector_js__WEBPACK_IMPORTED_MODULE_0__["default"])(swiper.params.pagination.bulletClass));
    if (!isBullet) return;
    e.preventDefault();
    const index = Object(_shared_utils_js__WEBPACK_IMPORTED_MODULE_2__["elementIndex"])(e.target) * swiper.params.slidesPerGroup;
    if (swiper.params.loop) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_init_accordion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/init-accordion */ "./js/modules/init-accordion.js");
...
/* harmony import */ var _utils_form_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/form/form */ "./js/utils/form/form.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var form = new _utils_form_form__WEBPACK_IMPORTED_MODULE_3__["Form"]();
  window.form = form;
  // iosVhFix();
  // initHeaderObserver();
  // initYearCorrection();
  ...
  var headerButton = header.querySelector('.header__accordion');
  var headerButtonText = header.querySelector('.header__accordion-text');
  var headerNav = header.querySelector('.header__nav');
  var overley = header.querySelector('.header__overlay');
  ...
  // main
  void new swiper__WEBPACK_IMPORTED_MODULE_4__["default"]('.main__wrap', {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_4__["Pagination"], swiper__WEBPACK_IMPORTED_MODULE_4__["Autoplay"], swiper__WEBPACK_IMPORTED_MODULE_4__["A11y"], swiper__WEBPACK_IMPORTED_MODULE_4__["Keyboard"]],
    loop: true,
    grabCursor: true,
    pagination: {
      el: '.main__pagination',
  ...
  var linkMain = document.querySelectorAll('.main__button_scroll');
  linkMain.forEach(function (link) {
  ...
  // command
  void new swiper__WEBPACK_IMPORTED_MODULE_4__["default"]('.command__swiper', {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_4__["Pagination"], swiper__WEBPACK_IMPORTED_MODULE_4__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_4__["Autoplay"], swiper__WEBPACK_IMPORTED_MODULE_4__["A11y"], swiper__WEBPACK_IMPORTED_MODULE_4__["Keyboard"]],
    grabCursor: true,
    loop: true,
    pagination: {
  ...
  // shop
  var shopTabs = document.querySelectorAll('.shop__button');
  shopTabs.forEach(function (link) {
  ...
  window.addEventListener('load', function () {
    // initSandwichMenu();
    Object(_modules_init_accordion__WEBPACK_IMPORTED_MODULE_0__["initAccordions"])();
    // initUpButton();
    // initMoveTo();
    // initNavbarMenu();
    Object(_modules_init_tabs__WEBPACK_IMPORTED_MODULE_1__["initTabs"])();
...
var contacts = function contacts(event) {
  event.preventDefault();
...
/* harmony import */ var _validator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validator */ "./js/utils/form/validator.js");
/* harmony import */ var _callback__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./callback */ "./js/utils/form/callback.js");
/* harmony import */ var _init_phone_input__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./init-phone-input */ "./js/utils/form/init-phone-input.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
/***/ "./js/utils/form/init-phone-input.js":
/*!*******************************************!*\
  !*** ./js/utils/form/init-phone-input.js ***!
  \*******************************************/
...
/***/ "./js/utils/form/regular-expression.js":
/*!*********************************************!*\
  !*** ./js/utils/form/regular-expression.js ***!
  \*********************************************/
...
/***/ "./js/utils/form/render-message.js":
/*!*****************************************!*\
  !*** ./js/utils/form/render-message.js ***!
  \*****************************************/
...
/* harmony import */ var _regular_expression__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./regular-expression */ "./js/utils/form/regular-expression.js");
/* harmony import */ var _matrix__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./matrix */ "./js/utils/form/matrix.js");
/* harmony import */ var _render_message__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./render-message */ "./js/utils/form/render-message.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
