...
/* harmony import */ var _modules_init_sandwich_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/init-sandwich-menu */ "./js/modules/init-sandwich-menu.js");
...
/* harmony import */ var _modules_init_dynamic_adaptive__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-dynamic-adaptive */ "./js/modules/init-dynamic-adaptive.js");
/* harmony import */ var _modules_init_accordion__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-accordion */ "./js/modules/init-accordion.js");
/* harmony import */ var _modules_init_up_button__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-up-button */ "./js/modules/init-up-button.js");
/* harmony import */ var _modules_init_move_to__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-move-to */ "./js/modules/init-move-to.js");
/* harmony import */ var _modules_init_navbar_menu__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-navbar-menu */ "./js/modules/init-navbar-menu.js");
/* harmony import */ var _modules_init_header_observer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-header-observer */ "./js/modules/init-header-observer.js");
/* harmony import */ var _modules_init_tabs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-tabs */ "./js/modules/init-tabs.js");
/* harmony import */ var _modules_init_navigation_changer__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-navigation-changer */ "./js/modules/init-navigation-changer.js");
/* harmony import */ var _modules_init_article_menu__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/init-article-menu */ "./js/modules/init-article-menu.js");
/* harmony import */ var _modules_init_change_number__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/init-change-number */ "./js/modules/init-change-number.js");
/* harmony import */ var _modules_init_fixed_navbar__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/init-fixed-navbar */ "./js/modules/init-fixed-navbar.js");
/* harmony import */ var _modules_init_year_correction__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/init-year-correction */ "./js/modules/init-year-correction.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  Object(_modules_init_dynamic_adaptive__WEBPACK_IMPORTED_MODULE_3__["initDynamicAdaptive"])();
  window.scrollLock = new _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_2__["ScrollLock"]();
  Object(_utils_ios_vh_fix__WEBPACK_IMPORTED_MODULE_0__["iosVhFix"])();
  Object(_modules_init_header_observer__WEBPACK_IMPORTED_MODULE_8__["initHeaderObserver"])();
  Object(_modules_init_year_correction__WEBPACK_IMPORTED_MODULE_14__["initYearCorrection"])();
  // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    Object(_modules_init_sandwich_menu__WEBPACK_IMPORTED_MODULE_1__["initSandwichMenu"])();
    Object(_modules_init_accordion__WEBPACK_IMPORTED_MODULE_4__["initAccordions"])();
    Object(_modules_init_up_button__WEBPACK_IMPORTED_MODULE_5__["initUpButton"])();
    Object(_modules_init_move_to__WEBPACK_IMPORTED_MODULE_6__["initMoveTo"])();
    Object(_modules_init_navbar_menu__WEBPACK_IMPORTED_MODULE_7__["initNavbarMenu"])();
    Object(_modules_init_tabs__WEBPACK_IMPORTED_MODULE_9__["initTabs"])();
    Object(_modules_init_navigation_changer__WEBPACK_IMPORTED_MODULE_10__["initNavigationChanger"])();
    Object(_modules_init_article_menu__WEBPACK_IMPORTED_MODULE_11__["initArticleMenu"])();
    Object(_modules_init_change_number__WEBPACK_IMPORTED_MODULE_12__["initChangeNumber"])();
    Object(_modules_init_fixed_navbar__WEBPACK_IMPORTED_MODULE_13__["initFixedNavbar"])();
...
/***/ "./js/modules/init-article-menu.js":
/*!*****************************************!*\
  !*** ./js/modules/init-article-menu.js ***!
  \*****************************************/
/*! exports provided: initArticleMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initArticleMenu", function() { return initArticleMenu; });
var initArticleMenu = function initArticleMenu() {
  var articleButton = document.querySelector('.article-menu__button');
  var articleButtonWrapper = document.querySelector('.article-menu__button-wrapper');
  var articleList = document.querySelector('.article-menu__list');
  var articleLinks = document.querySelectorAll('.article-menu__link');
  var articlePoint = document.querySelector('.article-menu__point');
  var articleMenu = document.querySelector('.article-menu');
  if (!articleButton) {
    return;
  }
  var getStickyText = function getStickyText() {
    var activeLink = document.querySelector('.article-menu__link.is-active');
    if (activeLink) {
      articlePoint.textContent = activeLink.textContent;
    }
  };
  var getStickyWidth = function getStickyWidth() {
    var pointStickyWidth = parseInt(getComputedStyle(articlePoint).width, 10);
    if (articlePoint.scrollWidth >= pointStickyWidth) {
      articlePoint.classList.add('is-long');
    } else {
      articlePoint.classList.remove('is-long');
    }
    articleLinks.forEach(function (item) {
  ...
  var getStickPosition = function getStickPosition() {
    var hero = document.querySelector('.hero');
    var heroPosition = hero.getBoundingClientRect().bottom;
    if (heroPosition <= 0) {
...
/***/ "./js/modules/init-change-number.js":
/*!******************************************!*\
  !*** ./js/modules/init-change-number.js ***!
  \******************************************/
/*! exports provided: initChangeNumber */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initChangeNumber", function() { return initChangeNumber; });
var numbersElements = document.querySelectorAll('[data-number-to]');
var DURATION = 200;
var DELAY = 10;
var changeNumbers = function changeNumbers(el) {
  var timer;
  var initialValue = 0;
  var desiredValue = Number(el.dataset.numberTo);
  var step = desiredValue / (DURATION - DELAY);
...
var trackingAnimateBlocks = function trackingAnimateBlocks() {
  numbersElements.forEach(function (number) {
...
var initChangeNumber = function initChangeNumber() {
...
/* harmony import */ var _utils_dynamic_adaptive__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/dynamic-adaptive */ "./js/utils/dynamic-adaptive.js");

var initDynamicAdaptive = function initDynamicAdaptive() {
  var dynamicAdaptive = new _utils_dynamic_adaptive__WEBPACK_IMPORTED_MODULE_0__["DynamicAdaptive"]('max');
...
/***/ "./js/modules/init-fixed-navbar.js":
/*!*****************************************!*\
  !*** ./js/modules/init-fixed-navbar.js ***!
  \*****************************************/
/*! exports provided: initFixedNavbar */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFixedNavbar", function() { return initFixedNavbar; });
var breakpointMd = window.matchMedia('(min-width:1024px)');
var navbar = document.querySelector('.navbar');
var header = document.querySelector('.header');
var footer = document.querySelector('.footer');
var contentWrapper = document.querySelector('.content__wrapper');
var getNavbarPosition = function getNavbarPosition() {
  if (!navbar) {
    return;
  }
  var windowHeight = document.documentElement.clientHeight;
  var headerPosition = header.getBoundingClientRect().bottom;
  var contentWrapperPosition = contentWrapper.getBoundingClientRect().top;
  var footerPosition = footer.getBoundingClientRect().y;
  var footerHeightVisible = windowHeight - footerPosition;
  if (breakpointMd.matches) {
    if (headerPosition >= contentWrapperPosition) {
      navbar.style.position = 'fixed';
      navbar.style.top = "".concat(header.offsetHeight, "px");
      navbar.style.left = 'auto';
      navbar.style.height = 'auto';
      if (footerHeightVisible >= 0) {
        // navbar.style.bottom = '0';
        navbar.style.bottom = "".concat(footerHeightVisible, "px");
...
var initFixedNavbar = function initFixedNavbar() {
  getNavbarPosition();
...
/***/ "./js/modules/init-header-observer.js":
/*!********************************************!*\
  !*** ./js/modules/init-header-observer.js ***!
  \********************************************/
/*! exports provided: initHeaderObserver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initHeaderObserver", function() { return initHeaderObserver; });
...
var initHeaderObserver = function initHeaderObserver() {
  ...
  var headerObserver = new ResizeObserver(function (entries) {
    ...
    main.style.paddingTop = "".concat(header.clientHeight, "px");
  });
...
/* harmony import */ var _utils_modals__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/modals */ "./js/utils/modals.js");
...
var initModals = function initModals() {
  ...
  modals = new _utils_modals__WEBPACK_IMPORTED_MODULE_0__["Modals"](settings);
...
/***/ "./js/modules/init-navbar-menu.js":
/*!****************************************!*\
  !*** ./js/modules/init-navbar-menu.js ***!
  \****************************************/
/*! exports provided: initNavbarMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initNavbarMenu", function() { return initNavbarMenu; });
var breakpointMd = window.matchMedia('(min-width:1024px)');
var navbarButton = document.querySelector('[data-navbar-open]');
var navbarCloseButton = document.querySelector('[data-navbar-close]');
var navbar = document.querySelector('.navbar');
var innerContent = document.querySelector('.content__inner');
var header = document.querySelector('.header');
var openNavbar = function openNavbar() {
  window.scrollLock.disableScrolling();
  navbar.classList.add('is-active');
};
var closeNavbar = function closeNavbar(unlock) {
  if (unlock) {
...
var stickyNavbarHandler = function stickyNavbarHandler() {
  var wrapperPosition = innerContent.getBoundingClientRect().top;
  if (wrapperPosition < header.clientHeight) {
    navbarButton.classList.add('is-active');
    navbarButton.style.transform = "translate3d(0, ".concat(header.clientHeight, "px, 0");
  } else {
    navbarButton.classList.remove('is-active');
    navbarButton.style.transform = 'translate3d(0, 0, 0';
  }
};
var initNavbarMenu = function initNavbarMenu() {
  if (navbarButton) {
...
/***/ "./js/modules/init-navigation-changer.js":
/*!***********************************************!*\
  !*** ./js/modules/init-navigation-changer.js ***!
  \***********************************************/
/*! exports provided: initNavigationChanger */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initNavigationChanger", function() { return initNavigationChanger; });
/* harmony import */ var _utils_navigation_changer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/navigation-changer */ "./js/utils/navigation-changer.js");

var initNavigationChanger = function initNavigationChanger() {
  var navigationChanger = new _utils_navigation_changer__WEBPACK_IMPORTED_MODULE_0__["NavigationChanger"]();
  setTimeout(function () {
...
/***/ "./js/modules/init-sandwich-menu.js":
/*!******************************************!*\
  !*** ./js/modules/init-sandwich-menu.js ***!
  \******************************************/
/*! exports provided: initSandwichMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSandwichMenu", function() { return initSandwichMenu; });
var breakpointMd = window.matchMedia('(min-width:1024px)');
var headerLogo = document.querySelector('[data-header-logo]');
var sandwich = document.querySelector('[data-sandwich]');
var nav = document.querySelector('[data-main-nav]');
var gitLink = document.querySelector('.header__git-link');
var openMenu = function openMenu() {
  var navItem = nav.querySelectorAll('[data-nav-item]');
  window.scrollLock.disableScrolling();
  ...
  navItem.forEach(function (item, index) {
    item.style.transitionDelay = "".concat(0.2 + index * 0.1, "s");
  });
};
var closeMenu = function closeMenu(unlock) {
  var navItem = nav.querySelectorAll('[data-nav-item]');
  if (unlock) {
    window.scrollLock.enableScrolling();
  }
...
/***/ "./js/modules/init-up-button.js":
/*!**************************************!*\
  !*** ./js/modules/init-up-button.js ***!
  \**************************************/
/*! exports provided: initUpButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initUpButton", function() { return initUpButton; });
var initUpButton = function initUpButton() {
  var upButton = document.querySelector('.up-button__inner');
  var innerContent = document.querySelector('.content__inner');
  var header = document.querySelector('.header');
  if (!upButton) {
    return;
...
/***/ "./js/modules/init-year-correction.js":
/*!********************************************!*\
  !*** ./js/modules/init-year-correction.js ***!
  \********************************************/
/*! exports provided: initYearCorrection */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initYearCorrection", function() { return initYearCorrection; });
var initYearCorrection = function initYearCorrection() {
  var dateItems = document.querySelectorAll('[data-year]');
  var today = new Date();
...
/***/ "./js/utils/navigation-changer.js":
/*!****************************************!*\
  !*** ./js/utils/navigation-changer.js ***!
  \****************************************/
    ...
    value: function _changeLinksActiveState() {
      ...
      this._linkElements.forEach(function (link, index) {
        ...
        if (currentBlockElement.getBoundingClientRect().bottom > _this._blockShift && currentBlockElement.getBoundingClientRect().top <= _this._blockShift) {
          if (_this._linkElements[index - 1]) {
